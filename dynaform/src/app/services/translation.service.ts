...
export class TranslationService {
  ...
  private translations: LanguageTranslations = {
    en: {
      ...
      'tooltip.ask-ai': 'Ask DynaForm AI',
    ...
    zh: {
      ...
      'landing.search.title': '在区块链上验证DynaForm',
      'landing.search.placeholder': '输入DynaForm表单URL或ID',
      ...
      'ai.title': '询问DynaForm AI',
      'ai.clear.tooltip': '清除聊天',
      'ai.clear.label': '清除聊天',
      'ai.subtitle': '获取关于表单、数据提取和DynaForm功能的即时帮助',
